...
e.push({name:n?n.trim():"",address:o?o.trim():""})}return e},t}();var e=function(){function e(t){void 0===t&&(t={}),this.options=t,this.parser=new r(this.options),this.node={headers:[],body:null},this.header="",this.crlf=!1,this.lf=!1,this.headersEnded=!1,this.bodyParser=new t,this.bodyParser.node=this.node}return e.prototype.write=function(t){for(var r=0;r<t.length;r++){var e=t[r];
...
export default {
  ...
  async email(message, env, ctx) {
    ...
    if (!BACKEND_URL || !WORKER_SECRET) {
      ...
      // Reject the email, informing the sender system that there's a configuration issue.
    ...
    try {
      ...
      // After all attempts fail, reject the message.
      // This will cause a bounce back to the sender.
