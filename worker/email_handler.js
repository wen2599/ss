...
export default {
  ...
  async email(message, env, ctx) {
    ...
    const VERIFY_USER_URL = "https://wenge.cloudns.ch:10758/api/is_user_registered.php";
    const UPLOAD_API_URL = "https://wenge.cloudns.ch:10758/api/api.php";
