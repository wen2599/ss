<?php
// backend/utils/ai_handler.php

/**
 * A generic helper function to make API calls using cURL.
 *
 * @param string $url The URL to send the request to.
 * @param array $payload The data to be sent in the request body, will be JSON encoded.
 * @param array $headers An array of HTTP headers.
 * @return array An associative array containing http_code, response_body, and curl_error.
 */
function _call_api_curl($url, $payload, $headers) {
    $ch = curl_init();
    ...
    curl_setopt($ch, CURLOPT_TIMEOUT, 60); // 60-second timeout for AI requests
