...
if (!$update) {
    // Still send an OK response to Telegram to acknowledge receipt of an empty call.
    Response::json(['status' => 'ok', 'message' => 'No update received.']);
    return;
}
...
// After all processing is done, send a final 'ok' response to Telegram.
