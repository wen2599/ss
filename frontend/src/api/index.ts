...
export const placeBet = (numbers: number[], lottery_type: string) => {
  return apiClient.post('/api/place_bet.php', { numbers, lottery_type });
};

export const getBetHistory = () => {
  return apiClient.get('/api/get_bet_history.php');
};
